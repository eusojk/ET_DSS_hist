...
def run_create_figure(n_clicks, tyear, intermediate):
    if n_clicks is None:
        ...
        # 2) Write V47 file
        Wdir_path = DSSAT_FILES_DIR
        print("1 Current wrking directory:", Wdir_path)
        ...
        print("2 Current wrking directory:", Wdir_path)
        ## Windows:
        ...
        ## Linux:
        print("DSSAT is about to run")
        args = "./DSCSM047.EXE MZCER047 B DSSBatch.V47"
        os.system(args) 
        # subprocess.call(args)
        print("DSSAT should be done running")
